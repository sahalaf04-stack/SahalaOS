...
void execute_command(char *command)
{
    ...
    if (equal(command, "help"))
    {
        ...
        print("rtc      - Show RTC time/date", row, 0, WHITE); row++;
        print("date     - Show current date", row, 0, WHITE); row++;
        print("clock    - Show current time", row, 0, WHITE); row++;
        ...
        print("kill     - Kill a process", row, 0, WHITE); row++;
        ...
        print("cd       - Change directory", row, 0, WHITE); row++;
        print("disktest - Test disk", row, 0, WHITE);
    }
...
void shell_init(void)
{
    ...
    print("========================================", 0, 0, CYAN);
    print("           SAHALA OS v0.3", 1, 0, GREEN);
    print("========================================", 2, 0, CYAN);
